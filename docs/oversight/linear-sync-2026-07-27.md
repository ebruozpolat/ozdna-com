...
> Done). Decide the naming before/at creation (see O7). Founder decision on record:
...
| Team | `ozDNA` · Project `ozDNA Oversight — AI Act runtime` |
...
| Deliverable | Issue |
|---|---|
| Homepage + /comply + /origin (EN) + shared CSS + gate | 6.3 row 1 |
| /oversight/tr/* + hreflang | 6.3 row 2 |
| Immortal MLRO EN+TR | 6.3 row 3 |
| Path-split, canonical/hreflang, 404/robots/sitemap, AlignX decouple | 6.3 row 4 |
| complyDNA classification report template | 6.3 row 5 |
| docs/oversight/ corpus + banners + CLAUDE.md/DOMAIN.md | 6.3 row 6 |
| Name-collision / brand / dates / deploy / prototype | 6.4 rows |
