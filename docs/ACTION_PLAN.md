...
| 0.3 | ozdna.com landing page + waitlist, two segments: (a) AI companies needing EU Art. 50 marking, (b) sellers/creators | TODO | $0 | THE demand validation. Static page, Cloudflare Pages or Vercel (non-commercial while it's just a waitlist). |
...
| 0.9 | Partner conversation + domain: OriginDNA owns ozDNA brand long-term; platform site stays until OriginDNA landing ships; humanizer never under ozDNA | IN PROGRESS | ~$10 domain | Domain released from alignxmedia + attached to ozdna-614 (Jul 7). Repurpose ozdna.com content → OriginDNA waitlist still TODO. |
